...
class MiniCssExtractPlugin {
  ...
  apply(compiler) {
    ...
    require('webpack'); // TODO bug in webpack, remove it after it will be fixed
    ...
    const {
      CssModule,
      CssDependency
    } = (0, _utils.shared)(webpack, webpack => {
      // eslint-disable-next-line no-shadow
      const CssModule = MiniCssExtractPlugin.getCssModule(webpack); // eslint-disable-next-line no-shadow
